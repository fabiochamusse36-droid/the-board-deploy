...
const envSchema = z.object({
  ...
  JWT_ISSUER: z.string().min(1).default("the-board-api"),
  JWT_AUDIENCE: z.string().min(1).default("the-board-web"),
  JWT_ACCESS_TOKEN_TTL_SECONDS: z.coerce.number().int().min(300).max(86_400).default(60 * 60 * 8),
